...
document.querySelectorAll("[data-action]").forEach(button => {
  button.addEventListener("click", () => {
    ...
    if (action === "open-library") {
      previewTitle.textContent = "Asset Library";
      previewBadge.textContent = "Coming Soon";
      previewText.textContent = "The library will store every generated sprite, book, culture, model, sound, comic, and export bundle locally on this device.";
